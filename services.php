...
<head>
    ...
    <title>Services - The Organised Types</title>
    ...
    <style>
        ...
        /* CARD FLIP CSS STRUCTURE (Reused from Index) */
        .card-wrapper {
            perspective: 1000px; 
            height: 300px; 
            box-sizing: border-box;
...
<body>
    ...
    <div class="services-hero">
        <div class="container">
            <h1>Our Custom Solutions and Packages</h1>
            <p>From strategic consulting to hands-on implementation of digital tools, we provide organised systems that scale with your needs.</p>
        </div>
    </div>
