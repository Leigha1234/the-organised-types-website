(function () {
  var fallbackHeaderMarkup = [
    ...
    '<header class="fallback-header"><div class="fallback-navbar"><a href="index.html" class="fallback-logo" aria-label="The Organised Types home"><img src="logo.jpg.webp" alt="The Organised Types Logo"></a><div class="fallback-menu-icon" onclick="toggleMenu()" aria-label="Open menu" role="button" tabindex="0"><span></span><span></span><span></span></div><nav id="main-nav" class="fallback-nav" aria-label="Primary"><a href="index.html" id="nav-index">Home</a><a href="services.html" id="nav-services">Services</a><a href="portfolio.html" id="nav-portfolio">Portfolio</a><a href="TOTS-OS.html" id="nav-tots-os">TOTS-OS</a><a href="about.html" id="nav-about">About</a><a href="contact.html" id="nav-contact">Contact</a></nav></div></header>'
  ].join('');

  var fallbackFooterMarkup = [
    '<footer class="fallback-footer">',
    '<div class="fallback-footer-grid">',
    '<div class="fallback-footer-section fallback-footer-logo"><a href="index.html"><img src="logo.jpg.webp" alt="The Organised Types Logo"></a></div>',
