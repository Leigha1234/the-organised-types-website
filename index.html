...
<head>
    ...
    <title>Home - The Organised Types</title>
    ...
    <style>
        ...
        /* --- PAGE-SPECIFIC STYLES: INDEX (Card Flip & Spacing) --- */
        .hero { 
            text-align: center; 
            padding: 60px 20px; 
        ...
        /* DESKTOP CARD FLIP CSS STRUCTURE */
        .card-wrapper {
            perspective: 1000px; 
            flex: 1 1 45%; 
            height: 250px; 
...
<body>
    ...
    <div class="container">
        <h2 class="section-heading">Ready to Optimize Your Efficiency?</h2>
